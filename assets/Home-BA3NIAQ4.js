import{u as e,c as n,j as t,L as o}from"./index-BIECAY3N.js";const p=e.div`
  width: 100%;
  display: flex;
  gap: 24px;
  margin-bottom: 24px;
...
`,c=e.div`
  max-width: 720px;
  border-radius: 30px;
  background: ${n.SILVER_BACKGROUND};
...
`,x=e.span`
  ...
  font-style: normal;
`,h=e.span`
  background-color: ${n.LIGHT_YELLOW};
  border-radius: 8px;
  max-width: 195px;
  font-style: italic;
  letter-spacing: -0.96px;
...
`,f=e.button`
  border-radius: 12px;
  background-color: ${n.YELLOW_BUTTON};
  width: 267px;
  height: 60px;
  color: rgb(18, 20, 23);
  font-family: Roboto;
...
`,r=e.p`
  ...
  text-align: start;
  width: ${a=>a.width||"96px"};
  flex-wrap: wrap;
`,y=()=>t.jsxs(b,{children:[t.jsxs(i,{children:[t.jsx(s,{children:"3,200 +"}),t.jsx(r,{children:"Experienced tutors"})]}),t.jsxs(i,{children:[t.jsx(s,{children:"300,000 +"}),t.jsx(r,{children:"5-star tutor reviews"})]}),t.jsxs(i,{children:[t.jsx(s,{children:"120 +"}),t.jsx(r,{width:"74px",children:"Subjects taught"})]}),t.jsxs(i,{children:[t.jsx(s,{children:"200 +"}),t.jsx(r,{children:"Tutor nationalities"})]})]}),L=y,T=e.div`
...
`;function v(){return t.jsx(t.Fragment,{children:t.jsxs(T,{children:[t.jsx(j,{}),t.jsx(L,{})]})})}export{v as default};
